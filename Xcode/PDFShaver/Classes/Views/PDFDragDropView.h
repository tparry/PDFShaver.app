...
@class PDFDragDropView;

@protocol PDFDragDropViewDelegate <NSObject>
@required
...
@interface PDFDragDropView : NSView

@property (nonatomic, weak) IBOutlet id<PDFDragDropViewDelegate> delegate;
